...
/**
 * ============================================================
 *  LIBAS MEHAL — ORDER EMAIL CONFIGURATION
 * ============================================================
...
define('RECIPIENT_EMAIL', 'support@libasmehal.com');
...
//    hPanel > Emails > Email Accounts (e.g. orders@libasmehal.com).
//    Using an address on a different domain than your website
//    is the most common reason order emails land in spam.
define('SENDER_EMAIL', 'support@libasmehal.com');
define('SENDER_NAME',  'Libas Mehal Website');

// 3) SITE_NAME
//    Shown in the email subject line and heading.
define('SITE_NAME', 'Libas Mehal');
